...
<section id="about_top" class="clearfix">
 <div class="container">
  <div class="row">
   ...
   <p style = "font-family:lucida bright;"> Our Gallery </p>
   </div>
  </div>
 </div>
 ...
 <div class="container">
  <div class="row">
   ...
   <?php
	...
	<a href="tambah_galeri.php" style="all:unset">
    <div class="col-sm-4">
     <div class="event_2i clearfix bordered-card" style="margin-bottom:2em;width: 375px;height: 280px;">
      <div class="event_2i1 clearfix" style="height:16.8em;display:flex; flex-direction:column;justify-content:center;align-items:center;text-align:center;">
	  <p class="add-symbol">+</p>
       <h4 class="mgt">Tambah Event</h4>
       <p>Tambahkan event untuk ditampilkan di halaman user</p>
      </div>
     </div>
    </div>
	</a>
